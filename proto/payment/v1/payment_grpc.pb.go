...
type PaymentServiceClient interface {
	CreatePaymentIntent(ctx context.Context, in *CreatePaymentIntentResponse, opts ...grpc.CallOption) (*CreatePaymentIntentResponse, error)
}
...
func (c *paymentServiceClient) CreatePaymentIntent(ctx context.Context, in *CreatePaymentIntentResponse, opts ...grpc.CallOption) (*CreatePaymentIntentResponse, error) {
...
type PaymentServiceServer interface {
	CreatePaymentIntent(context.Context, *CreatePaymentIntentResponse) (*CreatePaymentIntentResponse, error)
...
func (UnimplementedPaymentServiceServer) CreatePaymentIntent(context.Context, *CreatePaymentIntentResponse) (*CreatePaymentIntentResponse, error) {
...
func _PaymentService_CreatePaymentIntent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePaymentIntentResponse)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).CreatePaymentIntent(ctx, req.(*CreatePaymentIntentResponse))
	}
